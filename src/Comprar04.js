...
export default function Comprar() {
    const{setCompra04} = useContext( UserContext);
  return (
    <View style={css.caixaMairo}>
            ...
            <View>
                <TouchableOpacity style={css.btn01} >
                    <Text onPress={ () => setCompra04( false )}  style={css.Texto}>❮</Text>
                </TouchableOpacity>
            </View>
        ...
        <SafeAreaView style={css.container}>
            ...
            <View style={css.CaixaImga}>
                <Image style={css.ImageCarro} source={require("../assets/FotoCarro/Hamer.png")} />
